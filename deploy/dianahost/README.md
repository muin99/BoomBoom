...
The script stages current source with this manifest/lockfile, builds and tests it, then produces `artifacts/gridwise-dianahost-node20.zip`. Upload that archive through cPanel following [the deployment guide](../../docs/dianahost.md). The startup file in this directory is copied into the archive root.
